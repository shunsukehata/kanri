...
<body>
  ...
  <main>
    <div class="form">
      <table class="select-teble">
        ...
        <tbody>
          ...
          <tr>
            <th>役職</th>
            <td>${fn:escapeXml(loginUser.positionName)}</td>
          </tr>

          <tr>
            <th>名前</th>
            <td>${fn:escapeXml(loginUser.empName)}</td>
          </tr>

          <tr>
            <th>社員ID</th>
            <td>${fn:escapeXml(loginUser.empId)}</td>
          </tr>

        </tbody>
      </table>
      <a href="employeeUpdate" class="btn-insert">社員情報変更</a>
    </div>
        ...
        <div class="weather-customize" style="width:350px;">
          <div class="booked-weather-custom-160 color-009fde" style="width:350px;" id="width5">
            <div class="booked-weather-custom-160-date">天気, 21 6月</div>
              <div class="booked-weather-custom-160-main"> <a target="_blank" class="booked-weather-custom-160-city"> 東京都の天気 </a>
    ...
    <footer>
        <p class="fotter1">COPYRIGHT © Bgroup,Inc. All rights reserved.</p>
    </footer>
